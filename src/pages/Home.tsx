    ...
    <Layout>
      <Container maxWidth="lg">
        ...
        <Box sx={{ textAlign: 'center', py: 6, mb: 6 }}>
          ...
          >
            Sorularınızın cevaplarını bulun veya yeni sorular sorun! Topluluk
            ile birlikte öğrenin.
          </Typography>
          <Box
            sx={{
              display: 'flex',
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} md={6}>
              <Card sx={{ p: 3, height: '100%' }}>
                ...
                <Typography variant="body1" color="text.secondary">
                  Topluluk sayesinde sorularınıza hızlıca cevap alın. Uzmanlar
                  ve deneyimli kullanıcılar size yardımcı olmaya hazır.
                </Typography>
              </Card>
            </Grid>
            <Grid item xs={12} md={6}>
              <Card sx={{ p: 3, height: '100%' }}>
                ...
                <Typography variant="body1" color="text.secondary">
                  Her soru ve cevap moderasyon sürecinden geçer. Kaliteli ve
                  güvenilir içerik garantisi veriyoruz.
                </Typography>
              </Card>
            </Grid>
            <Grid item xs={12} md={6}>
              <Card sx={{ p: 3, height: '100%' }}>
                ...
                <Typography variant="body1" color="text.secondary">
                  Binlerce kullanıcıdan oluşan aktif topluluğa katılın. Bilgi
                  paylaşın, öğrenin ve büyüyün.
                </Typography>
              </Card>
            </Grid>
            <Grid item xs={12} md={6}>
              <Card sx={{ p: 3, height: '100%' }}>
                ...
                <Typography variant="body1" color="text.secondary">
                  Modern ve kullanıcı dostu arayüz ile sorularınızı kolayca
                  sorun ve cevapları hızlıca bulun.
                </Typography>
              </Card>
            </Grid>
          </Grid>
