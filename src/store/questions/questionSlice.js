...
const questionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    // Get all questions
    builder
      .addCase('questions/getAllQuestions/pending', (state) => {
        state.loading = true;
        state.error = null;
      })
      .addCase('questions/getAllQuestions/fulfilled', (state, action) => {
        state.loading = false;
        state.questions = action.payload.data;
        state.totalQuestions = action.payload.data.length;
      })
      .addCase('questions/getAllQuestions/rejected', (state, action) => {
        state.loading = false;
    ...
    // Get single question
      ...
      .addCase('questions/getQuestion/fulfilled', (state, action) => {
        state.loading = false;
        state.currentQuestion = action.payload.data;
      })
      .addCase('questions/getQuestion/rejected', (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
    ...
    // Ask question
      ...
      .addCase('questions/askQuestion/fulfilled', (state, action) => {
        state.loading = false;
        state.questions.unshift(action.payload.data);
        state.totalQuestions += 1;
      })
      .addCase('questions/askQuestion/rejected', (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
    ...
    // Edit question
      ...
      .addCase('questions/editQuestion/fulfilled', (state, action) => {
        state.loading = false;
      ...
      .addCase('questions/editQuestion/rejected', (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })
    ...
    // Delete question
      ...
      .addCase('questions/deleteQuestion/fulfilled', (state, action) => {
        state.loading = false;
        const questionId = action.meta.arg; // The question ID passed to the thunk
        state.questions = state.questions.filter(q => q._id !== questionId);
        state.totalQuestions -= 1;
      ...
      .addCase('questions/deleteQuestion/rejected', (state, action) => {
        state.loading = false;
        state.error = action.payload;
      })

    // Like question
      .addCase('questions/likeQuestion/fulfilled', (state, action) => {
        const updatedQuestion = action.payload.data;
        const index = state.questions.findIndex(q => q._id === updatedQuestion._id);
        if (index !== -1) {
          state.questions[index] = updatedQuestion;
    ...
    // Undo like question
      .addCase('questions/undoLikeQuestion/fulfilled', (state, action) => {
        const updatedQuestion = action.payload.data;
        const index = state.questions.findIndex(q => q._id === updatedQuestion._id);
        if (index !== -1) {
          state.questions[index] = updatedQuestion;
