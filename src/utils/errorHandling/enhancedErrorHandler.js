...
export class EnhancedErrorHandler {
  ...
  // Get error severity
  getErrorSeverity(errorType, context = {}) {
    switch (errorType) {
  ...
  getUserFriendlyMessage(errorType, error, context = {}) {
    const defaultMessages = {
      [ERROR_TYPES.NETWORK]: "İnternet bağlantınızı kontrol edin ve tekrar deneyin.",
      [ERROR_TYPES.TIMEOUT]: "İşlem zaman aşımına uğradı. Lütfen tekrar deneyin.",
      ...
      [ERROR_TYPES.AUTHORIZATION]: "Bu işlemi gerçekleştirmek için yetkiniz bulunmuyor.",
      ...
      [ERROR_TYPES.UNKNOWN]: "Beklenmeyen bir hata oluştu. Lütfen tekrar deneyin.",
    };
