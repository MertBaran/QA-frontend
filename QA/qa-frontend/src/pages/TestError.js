...
const TestError = () => {
  ...
  const testApiError = () => {
    try {
      ...
      handleApiError(error, { action: "testApi" });
    }
  };
  ...
  const testComponentError = () => {
    try {
      ...
      handleComponentError(error, "TestComponent", { prop1: "value1" });
    }
  };
  ...
  const testNetworkError = () => {
    try {
      ...
      handleNetworkError(error, { action: "fetchData" });
    }
  };
  ...
  const testUserActionError = () => {
    try {
      ...
      handleUserActionError(error, "click_button", {
        userId: "123",
        page: "test",
      });
    }
